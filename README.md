...
All you need to do to allow the scotomas to move with your eyes is to modify the following lines of code in the Update method of the ScotomaSimulator class.
